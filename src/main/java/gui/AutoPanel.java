...
public class AutoPanel extends JPanel {
    ...
    // Metodi generati dall'editor GUI
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        btnPrenota = new JButton();
        btnPrenota.setText("Prenota");
        bottomPanel.add(btnPrenota);
        btnManutenzione = new JButton();
        btnManutenzione.setText("In Manutenzione");
        bottomPanel.add(btnManutenzione);
        btnRendiDisp = new JButton();
        btnRendiDisp.setText("Rendi Disponibile");
        bottomPanel.add(btnRendiDisp);
    }
