...
public class ImpPagamentoDAO implements PagamentoDAO {
    ...
    public void salvaPagamento(Pagamento p) throws SQLException {
        ...
        String sql = """
            INSERT INTO PAGAMENTO (idpagamento, importo, stato, idnoleggio)
            VALUES (?, ?, ?, ?)
        """;
    ...
    public Pagamento trovaPagamentoPerId(int idPagamento) throws SQLException {
        ...
        String sql = """
            SELECT p.idpagamento, p.importo, p.stato,
                   n.idnoleggio, n.dataritiro
            FROM PAGAMENTO p
    ...
    private Pagamento mappaResultSetInPagamento(ResultSet rs) throws SQLException {
        ...
        Pagamento.StatoPagamento statoEnum =
                Pagamento.StatoPagamento.valueOf(
                        rs.getString("stato").toUpperCase()
                );
